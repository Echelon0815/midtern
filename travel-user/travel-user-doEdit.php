...
$sql = "UPDATE travel_account SET company_banner='$company_banner', account='$travel_account', password='$password',name='$name',company_name='$company_name',area='$area',company_phone='$company_phone',email='$email',bank_account='$bank_account',website='$website',introduction='$introduction' WHERE id='$id'";
